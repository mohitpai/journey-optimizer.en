...
+ Design content {#design}
  ...
  + [Design your email content in the UI](using/design/create-email-content.md)
  ...
  + Validate and publish {#validate}
    + [Check alerts](using/design/alerts.md)
    + [Publish messages](using/design/publish-manage-message.md)
