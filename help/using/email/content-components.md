...
You can add as many content components as you need inside a **[!UICONTROL Structure component]** which defines the layout of your email.

To access the **[!UICONTROL Content components]** in the Email designer, select the corresponding button from the left pane.

![](assets/email_designer_content_components.png)

## Button {#buttons}

Use the **[!UICONTROL Button]** component to insert multiple buttons into your email and redirect your email audience to another page.
