...
An audience is a set of people who share similar behaviors and/or characteristics. They can be generated by Adobe Experience Platform using segment definitions or audience composition, or imported from a CSV file. Learn more about audiences in the [Adobe Experience Platform Segmentation Service documentation](https://experienceleague.adobe.com/docs/experience-platform/segmentation/home.html){target="_blank"}.
