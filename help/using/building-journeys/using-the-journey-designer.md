...
You will find here the channel action activity which allows you to include a message designed in [!DNL Journey Optimizer]. [Learn more about the Message activity](journeys-message.md)
