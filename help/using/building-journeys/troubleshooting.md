...
## Checking for errors before testing{#checking-for-errors-before-testing}
...
## Checking that events are properly sent{#checking-that-events-are-properly-sent}
...
## Checking if people enter the journey{#checking-if-people-enter-the-journey}
...
## Checking how people navigate through the journey{#checking-how-people-navigate-through-the-journey}
...
## Checking that messages are sent successfully{#checking-that-messages-are-sent-successfully}
