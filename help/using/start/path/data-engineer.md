...
1. **Create test profiles**. Test profiles are required when using the [test mode](../../building-journeys/testing-the-journey.md) in a journey, and to [preview and test your messages](../../messages/preview.md) before sending. Discover steps to create test profiles [in this page](../../segment/creating-test-profiles.md).
