...
* The **profileID** field in this schema is defined as an identity field. In Customer Journey Analitycs, you then link this dataset to another dataset that uses the same idendity.
