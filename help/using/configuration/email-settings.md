...
Define the email settings in the dedicated section of the message surface configuration. Learn how to create channel surfaces in [this section](message-presets.md).
