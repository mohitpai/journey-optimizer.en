...
* Here you can download the blank Excel [IP warmup plan template](assets/IPWarmupPlan-Template.zip) to fill in.

* You can also download a [sample IP warmup plan](assets/IPWarmupPlan-Sample.zip) already filled in with some data you can use as an example.
...
1. Upload the Excel file containing your IP warmup plan. [Learn more](#prepare-file)
    ...
    >[!NOTE]
    >
    >In case the upload fails, make sure you are using the correct formatting and file format (.xls or .xlsx). Use the [template](assets/IPWarmupPlan-Template.zip) provided to you by Adobe.
