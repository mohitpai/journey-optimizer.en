...
However, to ensure that retry attempts are not performed anymore when no longer needed, you can change this setting according to your needs when creating or editing a [message surface](message-presets.md) applying to the email channel.
...
Learn how to adjust the email retry parameters when creating a message surface in [this section](message-presets.md#create-message-preset).
