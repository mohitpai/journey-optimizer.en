...
|Administration|<ul><li>**Manage subdomains delegation**: read, create, edit, and delete subdomain delegation.</li><li>**Manage IP pools**: read, create, edit, and delete ip pool.</li><li>**Manage PTR records**: read, create, edit, and delete PTR records.</li><li>**View PTR records**: read-only access to PTR records.</li><li> **Manage messages general settings**: read, create, edit, and delete message general settings.</li><li>**Manage messages presets**: read, create, edit, and delete content branding.</li><li>**Manage suppression rules**: access read, create, edit and delete suppression rules.</li><li>**View suppression list**: read and export local suppression list.</li><li>**Manage alerts**: enable/disable alerts for journeys, messages and entitlements.</li></ul>|
