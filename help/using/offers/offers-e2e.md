...
Now that your decision is live, you can insert it into an email message. To do so, follow the steps detailed in [this page](../../using/email/deliver-personalized-offers.md).
