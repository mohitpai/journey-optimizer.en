...
Use Journey Optimizer to create In-app notifications, and configure experience options, including the message layout and display, text, and button options. You can add In-app messages [in a campaign](create-in-app.md) and [in a journey](create-in-app-journey.md).
